...
CREATE VIEW v_radek_marval_mezirocni_zmeny_cen AS (                    -- vytvoření pomocného view s meziročními změnami cen (včetně poklesů cen)    	
WITH zmeny_cen AS (
SELECT
	rok,
	nazev_produktu,
...
CREATE VIEW v_radek_marval_mezirocni_zmeny_cen_pouze_ZDRAZENI AS (WITH zmeny_cen AS (						-- vytvoření pomocného view s meziročními změnami cen u produktů, u nichž došlo pouze ke zdražení
SELECT
	rok,
	nazev_produktu,
	cena_produktu,
